    ...
    <Container size='lg' className='py-6 sm:py-8 md:py-12'>
      <div className='space-y-6 sm:space-y-8'>
        ...
        <Card className='shadow-lg border-primary/20'>
          ...
          <CardContent>
            <p className='text-sm sm:text-base text-foreground leading-relaxed'>
              Сайт использует технические cookie (необходимые для работы) и
              аналитические cookie (только с вашего согласия). Вы можете отозвать
              согласие в любой момент в настройках профиля или управлять настройками
              cookies в браузере — это может повлиять на функциональность сайта.
            </p>
          </CardContent>
        </Card>
