    ...
    <Container size='lg' className='py-6 sm:py-8 md:py-12'>
      <div className='space-y-6 sm:space-y-8'>
        <div className='text-center space-y-3 sm:space-y-4'>
          <h1 className='text-3xl sm:text-4xl font-bold text-foreground'>Правила использования</h1>
          ...
          <CardContent className='space-y-4'>
            <div>
              <p className='text-sm sm:text-base text-foreground leading-relaxed mb-4'>
                Используя платформу Дохкар, вы соглашаетесь соблюдать следующие правила и требования.
                Нарушение правил может привести к блокировке аккаунта и удалению объявлений.
              </p>
            </div>
            <div className='space-y-3'>
              ...
              <div>
                ...
                <p className='text-sm sm:text-base text-muted-foreground leading-relaxed'>
                  Фотографии должны быть четкими и соответствовать реальному состоянию недвижимости.
                  Запрещается использование чужих фотографий или изображений из интернета.
                </p>
              </div>
              <div>
                <p className='text-sm sm:text-base font-semibold text-foreground mb-2'>
                ...
                <p className='text-sm sm:text-base text-muted-foreground leading-relaxed'>
                  Указывайте актуальные контактные данные. Не размещайте чужие телефоны или email
        ...
        <Card className='shadow-lg border-primary/20'>
          ...
          <CardContent className='space-y-4'>
            <div>
              ...
              <p className='text-sm sm:text-base text-muted-foreground leading-relaxed'>
                Покупатели обязаны самостоятельно проверять документы на недвижимость перед
                совершением сделки. Платформа Дохкар не несет ответственности за подлинность
                документов и правовую чистоту сделок.
              </p>
            </div>
            <div>
              <p className='text-sm sm:text-base font-semibold text-foreground mb-2'>
            ...
            <div>
              ...
              <p className='text-sm sm:text-base text-muted-foreground leading-relaxed'>
                Администрация оставляет за собой право модерировать, редактировать или удалять
                объявления, которые нарушают правила платформы, без предварительного уведомления.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/20">
          ...
          <CardContent>
            ...
            <ul className='space-y-2 text-sm sm:text-base text-muted-foreground list-disc list-inside ml-2'>
              ...
              <li>Передать информацию в правоохранительные органы при подозрении в мошенничестве</li>
            </ul>
          </CardContent>
        </Card>
