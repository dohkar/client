...
export function ListingRealEstateBasicSection({
  register,
  setValue,
  watch,
  errors,
  priceDisplay,
  setPriceDisplay,
}: ListingRealEstateBasicSectionProps) {
  return (
    <SectionCard
      ...
      <div className='flex flex-col gap-4 md:flex-row md:gap-6'>
        <div className='space-y-1 flex-1 min-w-[180px]'>
          ...
          <Select
            ...
            onValueChange={(v) => setValue("dealType", v as ListingFormData["dealType"])}
          >
        ...
        <div className='space-y-1 flex-1 min-w-[180px]'>
          <Label htmlFor='listing-re-price' className='text-sm font-medium'>
            Цена{" "}
