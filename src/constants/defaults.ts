/**
 * Дефолтные значения для поиска и региона.
 * Используются в: layout.tsx (OpenSearch), middleware.ts, hero-search.tsx,
 * use-segment-search-filters.ts, use-user-region.ts, search/page.tsx,
